...
import "https://github.com/PeaceCoinFinance/PeaceCoinFinance/blob/main/NFTGenesis.sol";
import "https://github.com/PeaceCoinFinance/PeaceCoinFinance/blob/main/PeaceCoinFinance.sol";
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  NFTGenesis nft;
  PeaceCoinFinance token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(NFTGenesis _nft, PeaceCoinFinance _token) { 
    nft = _nft;
    token = _token;
  }
